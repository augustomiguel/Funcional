defmodule Ativ3Test do
  ...
  test "obtem o n-esimo elemento de uma lista" do
    assert Ativ3.terceiro([], 5) == nil
    assert Ativ3.terceiro([],0) == nil
    assert Ativ3.terceiro([1, 2, 3,4,5],5,6) == 6
    assert Ativ3.terceiro([1, 2, 3],9) == nil
    assert Ativ3.terceiro([0],0) == 0
    assert Ativ3.terceiro([0,1],1) == 1
  end
