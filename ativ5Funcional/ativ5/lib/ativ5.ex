defmodule Ativ5 do
  ...
  def tamanho_strings(ls), do: String.length(ls)

  def tamanho_strings([]), do: []
  def tamanho_strings([x | y]), do: [String.length(x) | tamanho_strings(y)]
  ...
  def converte_para_inteiros(l), do: [String.to_integer(x) | converte_para_inteiros(y)]
  ...
  def soma_100_lista([x|resto]), do: [x + 100 | soma_100_lista(resto)]
  ...
  [501, 502, 503, 504, 505]
  """
  def soma_n_lista([], n), do: [n]
  def soma_n_lista([x|resto], n), do:  [x + n | soma_n_lista(resto , n )]
  ...
  def adiciona_prefixo([x | y], pre), do: [n <> (x) | adiciona_prefixo(y, pre)]
  @doc """
  ...
  def adiciona_sufixo([x | y], n), do: [(x) <> n  | adiciona_sufixo(y, n)]
  ...
  def fold_right([x | y], ini, f), do: f.(x, fold_right(y, ini, f))
  ...
  def or_lista([x | y]), do: (x) or (or_lista(y))
  ...
  def fold_left([x | y], ini, f), do: f.(fold_left(y, ini, f), x )
  ...
  def concatena_listas([x | y]), do:  x ++ concatena_listas(y)
  ...
  def concat_strings_sep([x | y], n), do: x <> n <> concat_strings_sep(y, n)
